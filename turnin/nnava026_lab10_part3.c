 ...
 *	Video: https://youtu.be/cx2RRRChXKA
...
enum Bell_States{wait_press, melody, endbell}Bell_State;
...
//TASK3: Doorbell
task3.state = start;
task3.period = 2; //because button check 200ms so this is the base
